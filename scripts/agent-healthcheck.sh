...
run_npm_script_if_present "PR report sensitive-content smoke" "harness:pr-report-sensitive-smoke"
...
run_npm_script_if_present "Extension guide Cloud Sync copy smoke" "cloud:extension-guide-copy-smoke"
run_npm_script_if_present "PC guide Cloud Sync copy smoke" "cloud:pc-guide-copy-smoke"
...
run_npm_script_if_present "Real crawl overview smoke" "crawler:real-overview-smoke"
