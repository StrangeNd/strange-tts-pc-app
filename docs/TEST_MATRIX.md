...
| Video downloader safety | User downloads only videos the selected shop/profile can already view | Video downloader safety smoke, UI shell smoke, syntax, healthcheck, browser UI QA, no cookie/token/session engine review | in_progress | `PROFILE_VIDEO_DOWNLOADER_SAFETY_PR_REPORT.md`; `scripts/video-downloader-safety-smoke.mjs`; `docs/stories/US-014-profile-video-downloader-safety.md` |
