...
| Business analysis | Combine crawler and XLSX/CSV/TSV/TXT inputs into readable analysis with Ads Spend, refund/cancel, and SKU performance clarity | Fixture-based calculation check plus UI review; missing-data review for unavailable spend components and refund/cancel source fields | in_progress | `scripts/spreadsheet-smoke.mjs`; `XLSX_AUDIT_FIX_PR_REPORT.md`; `SHOP_BUSINESS_METRICS_DASHBOARD_PR_REPORT.md`; `REFUND_CANCEL_BUSINESS_METRICS_PR_REPORT.md`; `docs/stories/US-006-shop-business-metrics-dashboard.md`; `docs/stories/US-007-refund-cancel-business-metrics.md` |
