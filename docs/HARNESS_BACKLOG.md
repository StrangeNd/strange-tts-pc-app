...
| HB-002 | Agent reports can drift from the test matrix | Add a report template that requires mapping every changed flow to `docs/TEST_MATRIX.md` | implemented: `docs/templates/pr-report.md`; `scripts/pr-report-template-smoke.mjs` |
